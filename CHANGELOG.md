...
- CI reworked end to end: staged test pipeline, SHA-pinned actions, hardened
  permissions, and an sdist completeness check derived from the build's own
  source discovery.
...
[Unreleased]: https://github.com/vfhe/vfhe/compare/0.0.1...HEAD
