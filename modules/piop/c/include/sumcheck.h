...
extern "C"
{
    ...
    void sumcheck_round_pairs(RNS_Polynomial g0, RNS_Polynomial g1,
                              RNS_Polynomial *table, uint64_t size);
    void sumcheck_round_halves(RNS_Polynomial g0, RNS_Polynomial g1,
                               RNS_Polynomial *table, uint64_t size);
