...
of Relation_Sum / Relation_Zero / Relation_Eval over ML_Polynomial and
MLE_Dense oracles, statement reduction chaining, and future resolution.
"""
...
def test_relation_open_unimplemented():
    stmt = Statement(Relation_Open())
